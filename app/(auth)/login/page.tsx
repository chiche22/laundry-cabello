  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="bg-white rounded-2xl shadow-md w-full max-w-sm p-8">
        <h1 className="text-2xl font-bold text-gray-900 mb-1 text-center">🧺 Laundry Cabello</h1>
        <p className="text-gray-500 text-sm text-center mb-6">Ingresá a tu cuenta</p>
